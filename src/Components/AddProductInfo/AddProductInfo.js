...
const AddProductInfo = ({
  ...
  const renderProductInfoComp = (
    ...
    if (type === 'Pricing') {
      return (
        <Pricing
          onPSBtnPress={onPSBtnPress}
          onCancelPress={onCancelPress}
          onGOBBtnPress={onGOBBtnPress}
          show={show}
          setShow={setShow}
        />
      );
    ...
    if (type === 'Description') {
      return (
        <Description
          onDSBtnPress={onDSBtnPress}
          onCancelPress={onCancelPress}
          onDGOBBtnPress={onBtnPress}
        />
      );
    }
    ...
    if (type === 'ImagesVideos') {
      return (
        <ImagesVideos
          onISBtnPress={onISBtnPress}
          onCancelPress={onCancelPress}
          onIGOBBtnPress={onPSBtnPress}
        />
      );
    }
    ...
    if (type === 'Variations') {
      return (
        <Variations
          ...
          onVSFBtnPress={onISBtnPress}
          onCancelPress={onCancelPress}
          onVGOBBtnPress={onDSBtnPress}
          vshow={variationshow}
          setVShow={setVariationShow}
        />
      );
    }
  };
  return (
    <View>
      <Text style={styles.productinfotext}>
        Rudraksha &gt; 11 Mukhi Rudraksha
      </Text>

      <View style={styles.productinfobtnbox}>
        <TouchableOpacity
          onPress={() => setBtnClick('Product Vital Info')}
          style={styles.productinfobtn}>
          <Text
            style={
              btnclick === 'Product Vital Info'
        ...
        <TouchableOpacity
          ...
          <Text
            style={
              btnclick === 'Pricing' ? styles.pinfobtntextcolor : styles.btntext
            }>
            Pricing
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          onPress={() => setBtnClick('Description')}
          style={[
            styles.productinfobtn,
            {borderLeftWidth: 1, borderLeftColor: '#D9D9D9'},
          ]}>
        ...
        <TouchableOpacity
          onPress={() => setBtnClick('ImagesVideos')}
          style={[
            styles.productinfobtn,
            {borderLeftWidth: 1, borderLeftColor: '#D9D9D9'},
          ]}>
        ...
        <TouchableOpacity
          onPress={() => setBtnClick('Variations')}
          style={[
            styles.productinfobtn,
            {borderLeftWidth: 1, borderLeftColor: '#D9D9D9'},
          ]}>
