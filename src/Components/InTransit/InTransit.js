...
import styles from './intransitstyle';
  ...
  return (
    <View>
      <View style={styles.ordercompinput}>
        <Text style={styles.orderinputtext}>In transit</Text>
      ...
      <View style={styles.datetimebox}>
        ...
        <View style={styles.ordercompdatetime}>
          <Text style={styles.datetimetext}>Dispatch date</Text>
          <TouchableOpacity>
            <Image source={require('../../assets/Icons/calendar.png')} />
          </TouchableOpacity>
        </View>
      ...
      <OrderCompBox
        ...
        Customertext3="Dispatch date | Time"
