...
const AddBulkCatalog = props => {
  ...
  const [subcategoryToggle, setSubCategoryToggle] = React.useState(false);
  return (
    <View
      style={{
        flex: 1,
      ...
      <SafeAreaView style={styles.paymentcontainer}>
        ...
        <View style={styles.catalogbottomhead}>
          <Text style={[styles.catalogbottomtext, {fontSize: 16}]}>
            Catalog uploads &gt; Add bulk catalog
          </Text>
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          justifyContent: 'center',
                          backgroundColor:
                            index === subcategoryInd ? '#FF6658' : '#D9D9D980',
                        }}>
                        <Text
                          style={{
                            fontSize: 12,
      ...
      {!hide && (
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate('AddBulkProductInfo');
